...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.train_no += 1
            #self.epsilon = self.alpha ** self.train_no
            #self.epsilon = self.a ** self.train_no
            self.epsilon = math.exp(-self.a * self.train_no)
...
def run():
    ...
    #env = Environment()
    #verbose = True  #added by GardenHo
    ...
    #enforce_deadline = True #added by GardenHo
    ...
    #sim = Simulator(env)
    #display = True #added by GardenHo
    #sim = Simulator(env, update_delay=0.1, display=True, log_metrics=True, optimized=False)
    ...
    #sim = Simulator(env, update_delay=0.000001, display=True, log_metrics=True, optimized = True)
    #sim = Simulator(env, update_delay=2, display=True, log_metrics=True, optimized = True)
